...
HELP
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        match ($format) {
            'json' => $output->writeln(json_encode($result, \JSON_PRETTY_PRINT | \JSON_UNESCAPED_SLASHES)),
            'toon' => $output->writeln(Toon::encode($result)),
            default => $this->renderPretty($result, $io),
        };
